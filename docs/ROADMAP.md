...
## 지금 다음 액션
**Milestone A·B·C 완료, Milestone E(볼륨업) 착수 — E1·E2·E3·E4 완료**(2026-07-18). B3(안개·탐험)·병종 다양화(7번째 유닛)는 계속 보류/확정 종료. 다음은 **E5(중후반 온보딩 확장 — 드래곤/공성/시즌/세력 시스템의 진입 장벽을 낮추는 안내)**.
