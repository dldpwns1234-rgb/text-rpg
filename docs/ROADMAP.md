...
- **미착수**: E2(몬스터/보스 개성) · E3(전투 연출/피드백) · E4(연구 트리 갈림길화) · E5(중후반 온보딩 확장) — 다음 세션에서 순서대로.

## 지금 다음 액션
**Milestone A·B·C 완료, Milestone E(볼륨업) 착수 — E1 완료**(2026-07-18). B3(안개·탐험)·병종 다양화(7번째 유닛)는 계속 보류/확정 종료. 다음은 **E2(몬스터·보스 개성 — "숫자만 큰 늑대" 탈피)**.
